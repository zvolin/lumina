...
## [0.4.0](https://github.com/zvolin/lumina/compare/lumina-node-wasm-v0.3.0...lumina-node-wasm-v0.4.0) - 2024-10-03
...
- remove tsconfig
- Merge branch 'main' into chore/auto-generate-ts-types
- Include API in readme  ([#409](https://github.com/zvolin/lumina/pull/409))
- *(node-wasm)* Switch to bundler target for wasm-pack for manifest v3 ([#398](https://github.com/zvolin/lumina/pull/398))
